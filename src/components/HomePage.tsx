        ...
        <HomeSection>
            ...
            <HowItWorksGrid>
                <div>
                    <h3>1. Quiz</h3>
                    <p>
                        Test your machine learning knowledge by answering questions from the quiz. You will not see the
                        answers to the quiz questions yet.
                    </p>
                </div>
                <div>
                    <h3>2. Leaderboard</h3>
                    <p>
                        Your answers are evaluated and your performance is compared to other users to determine your
                ...
                <div>
                    <h3>3. NFT badge</h3>
                    <p>
                        If you get enough answers, you will receive an NFT badge as a proof of your performance. The
                        proof is stored on the blockchain.
                    </p>
                </div>
            </HowItWorksGrid>
        </HomeSection>
